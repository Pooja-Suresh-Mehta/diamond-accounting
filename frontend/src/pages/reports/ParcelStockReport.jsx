...
const COLS = [
  ...
  { key: 'carats', label: 'Carats', num: true },
  { key: 'on_hand_weight', label: 'On Hand', num: true },
  { key: 'on_memo_weight', label: 'MemoOut', num: true },
  { key: 'size', label: 'Size' },
  { key: 'color', label: 'Color' },
  { key: 'clarity', label: 'Clarity' },
  { key: 'asking_price_usd_carats', label: 'Rate', num: true },
  { key: 'asking_usd_amount', label: 'Amount', num: true },
  { key: 'stock_group_id', label: 'Item Group' },
];
